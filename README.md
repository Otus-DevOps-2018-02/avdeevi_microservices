...
# Домашнее задание номер 21
 ...
 - Пересобраны docker-образы приложения с из новых исходных кодов (тег -logging)
 - Cобран docker-образ с  fluentd и кастомизированным конфигом.
 - Создан файл docker-compose-logging.yml и поднят  EFK  стек.
 - Дополнен compose файл основного приложения для использования драйвера логирования fluentd для сервиса post.
 - Исследованы возможности Кибаны по отображению и фильтрации логов.
 - Добавлен фильтр в  fluentd-конфиг  для парсинга логов в формате json.
 - Дополнен compose файл основного приложения для использования драйвера логирования fluentd для сервиса ui.
 - Дополнен конфиг  fluentd для парсинга неструктурированных логов посредством регулярных выражений и проведен тест.
 - Изменен конфиг fluentd для парсинга неструктурированных логов посредством  GROK-парттенов и проведен тест.
 - В compose-файл для сервисов логгирования добавлен сервис распределенного трейсинга  Zipkin
 - Поднят  Zipkin, проведены тесты и исследование возможностей системы распределенного трейсинга.

# Домашнее задание номер 22
 - Созданы файлы с деплоймент-манифестами приложений.
 - Пройден туториал "Kubernetes The Hard Way"
 - Проверена работа деплоймент-манифестов на вновь созданном кластере.
 - Кластер удален.
